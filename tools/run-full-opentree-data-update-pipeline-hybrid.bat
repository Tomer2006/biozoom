@echo off
REM ============================================
REM  Update OpenTreeofLife Taxonomy Data Pipeline (Hybrid Sort)
REM ============================================
REM
REM Prerequisites:
...
REM   6. Bake D3 circle-packing layout with Hybrid sorting (expensive operation)
REM   7. Capitalize names in split files (final formatting step)
REM
REM Hybrid sorting combines:
REM   - Primary: By value (descending) - larger groups get priority
REM   - Secondary: By depth (shallow first) - higher taxonomic levels for ties
REM
REM This approach balances size-based importance with taxonomic hierarchy.
REM ============================================
...
echo ============================================
echo Step 6: Baking D3 layout (Hybrid sort)...
echo ============================================
echo (This may take several minutes for large datasets)
echo (Using Hybrid sorting: value first, then depth for ties)
...
echo Layout uses Hybrid sorting (value primary, depth secondary)
