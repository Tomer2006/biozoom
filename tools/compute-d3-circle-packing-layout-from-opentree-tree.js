#!/usr/bin/env node
/**
 * Bake D3 circle-packing layout for OpenTreeofLife tree
 *
...
async function main() {
  console.time('bake-layout-opentree');
  ...
  const manifest = {
    version: '1.0',
    description: 'Pre-baked D3 circle-packing layout for OpenTreeofLife taxonomy tree',
  ...
  console.timeEnd('bake-layout-opentree');
  console.log('Done!');
}
