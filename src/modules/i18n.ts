...
const translations: Record<AppLanguage, Record<string, TranslationValue>> = {
  en: {
    ...
    onboarding: {
      ...
      toolsPoint3: 'Press W to web search the hovered node.',
    },
    landing: {
    ...
    help: {
      ...
      searchKey: 'W',
      searchDescription: 'Web search hovered node',
      webSearchHint: 'Press W to web search the hovered node.',
      resetKey: 'R',
    ...
    app: {
      ...
      hoverToWebSearch: 'Hover a node to web search it.',
    },
    data: {
  ...
  he: {
    ...
    onboarding: {
      ...
      toolsPoint3: 'לחצו על W כדי לחפש ברשת את הצומת שמתחת לסמן.',
    },
    landing: {
    ...
    help: {
      ...
      searchKey: 'W',
      searchDescription: 'חיפוש ברשת עבור הצומת שמתחת לסמן',
      webSearchHint: 'לחצו על W כדי לחפש ברשת את הצומת שמתחת לסמן.',
      resetKey: 'R',
    ...
    stage: {
      ...
      noImage: 'אין תמונה',
      unknown: 'לא ידוע',
      webSearch: 'חיפוש על המרוחף (W)',
      webSearchTitle: 'חיפוש ברשת עבור הצומת שמתחת לסמן (W)',
    },
    app: {
